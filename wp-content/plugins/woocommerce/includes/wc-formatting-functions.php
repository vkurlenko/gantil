...
function wc_format_sale_price( $regular_price, $sale_price ) {
	$price = 'Обычная цена <del>' . ( is_numeric( $regular_price ) ? wc_price( $regular_price ) : $regular_price ) . '</del><br>
	Цена по акции ' . ( is_numeric( $sale_price ) ? wc_price( $sale_price ) : $sale_price ) . '';
