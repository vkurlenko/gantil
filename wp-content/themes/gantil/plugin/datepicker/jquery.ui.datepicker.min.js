...
"":this._formatDate(a))},_getDate:function(a){return!a.currentYear||a.input&&a.input.val()==""?null:this._daylightSavingAdjust(new Date(a.currentYear,a.currentMonth,a.currentDay))},



_generateHTML:function(a){var b=new Date;b=this._daylightSavingAdjust(new Date(b.getFullYear(),b.getMonth(),b.getDate()));var c=this._get(a,"isRTL"),e=this._get(a,"showButtonPanel"),f=this._get(a,"hideIfNoPrevNext"),h=this._get(a,"navigationAsDateFormat"),i=this._getNumberOfMonths(a),g=this._get(a,"showCurrentAtPos"),k=
...
A);t=(this._getFirstDayOfMonth(m,g)-h+7)%7;A=l?6:Math.ceil((t+A)/7);q=this._daylightSavingAdjust(new Date(m,g,1-t));
...
var P=!k?"":'<td class="ui-datepicker-week-col">'+this._get(a,"calculateWeek")(q)+"</td>";for(t=0;t<7;t++){var F=p?p.apply(a.input?a.input[0]:null,[q]):[true,""],B=q.getMonth()!=g,J=B&&!H||!F[0]||j&&q<j||o&&q>o;
...
/*var start = new Date(q.getFullYear()-1, 11, 31)
var one_day=1000*60*60*24*/

//var thisDay = Math.ceil((q.getTime()-start.getTime())/(one_day));

var thisDay = NumDay(q.getDate(),q.getMonth()+1, GoodYear(q.getYear()))

var hl = thisDay%4

var year = new Array()
//document.write(GoodYear(q.getYear())+'<br>')
switch(GoodYear(q.getYear()))
{
	case 2014 :	year = ['red', 'red', 'green', 'green']; break;
	case 2015 :	year = ['red', 'green', 'green', 'red']; break;
	case 2016 :	year = ['green', 'green', 'red', 'red']; break;
	case 2017 :	year = ['red', 'red', 'green', 'green']; break;
	default: break;
}
...
P+='<td class="'+ cl + ' ' + ((t+h+6)%7>=5?" ui-datepicker-week-end":"")+(B?" ui-datepicker-other-month":"")+(q.getTime()==N.getTime()&&g==a.selectedMonth&&
