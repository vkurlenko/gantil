	...
	<script async src="<?php echo get_template_directory_uri(); ?>/plugin/bootstrap/js/validator.js"></script>
	...
	<script type="text/javascript" src="/wp-content/themes/gantil/js/script.js?v=5.22"></script>	
