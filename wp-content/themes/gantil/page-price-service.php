							   					...
							   					foreach($list as $k => $v)
												{
                                                    ...
                                                    <tr class="category-name-tr" id="<?=$cat_id?>">
                                                        ...
                                                        <td><h<?= 3+$v['lvl']?> class="category-name">
                                                                <i class="fa fa-caret-right" style="padding:0 10px 0 0" aria-hidden="true"></i>
                                                                <?= $v['name']?> <?/*= $num*/?>
                                                            </h<?= 3+$v['lvl']?>>
                                                        </td>
                                                        <td></td>
													...
													foreach($goods as $obj)
													{
														...
														foreach($arr_str as $main_key => $pr)
														{
															...
															<tr class="category-item-<?=$cat_id?>">
																...
																{
																	$m = $n;
																	$link = wc_get_product_category_list( $obj->ID);
																	$link = "/product/".$obj->post_name."/";
																	?>
																	<td><?=$i++?></td>
																	<td class="item-name"><a href="<?=$link?>"><?=$m?></a></td>
