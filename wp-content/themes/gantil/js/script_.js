...
function initMask() {
	...
	var arr = new Array('input-tel', 'input-tel2', 'tel-697', 'tel-698', 'tel-699', 'tel-568', 'tel-700', 'billing_phone', 'vacancy-phone');
...
$(function(){
    ...
    document.querySelector('#callback-expecto').style.display = 'block';

    setInterval(function(){
        document.querySelector('#callback-expecto .callback-ico').classList.toggle('tada');
    }, 1000);
